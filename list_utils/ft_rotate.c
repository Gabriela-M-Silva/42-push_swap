...
static void	set_new_last_node(t_rotate *new, t_doubly_list **stack);
static void	set_new_first_node(t_rotate *new, t_doubly_list **stack);
static void	set_new_penult_node(t_rotate *new, t_doubly_list **stack);
...
static void	set_new_penult_node(t_rotate *new, t_doubly_list **stack)
{	
	new->penult_node = ft_doubly_list_last(*stack);
